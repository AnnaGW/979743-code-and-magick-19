...
(function () {
  ...
  userWizardCoat.addEventListener('click', function () {
    changeColorOnClick(userWizardCoat, userWizardCoatInputValue, window.consts.COAT_COLORS);
  });

  userWizardEyes.addEventListener('click', function () {
    changeColorOnClick(userWizardEyes, userWizardEyesInputValue, window.consts.EYES_COLORS);
  });
